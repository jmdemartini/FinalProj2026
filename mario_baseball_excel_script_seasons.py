...
#find files, if separating by seasons change directory
stat_folder = (
    Path.home()
    / "Library"
    / "Application Support"
...
#minimum appearances for stat leaders
MIN_AB = 50
MIN_OUTS = 30
# --------------------------
...
for file in matchingfiles:
    with open(file, "r") as f:
        ...
        # filter for choosing opponent and profile, if you want ALL stats, delete the "and" ones, and type anything when prompted for opponent
